...
public class C07_arrayList {
    public static void main(String[] args) {
        ...
        System.out.println("Liste boş mu : " + sayilar.isEmpty()); // true
        ...
        System.out.println("Liste boş mu : " + sayilar.isEmpty()); // false
        ...
        System.out.println(sayilar.contains(rakamlar)); // false
